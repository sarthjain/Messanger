...
public class ImagePreview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(ContextCompat.getColor(this, R.color.ColorHeading));
        }
    ...
    public void onBackPressed() {
        if (CropMode) {
            ...
            Crop.setImageResource(R.drawable.ic_crop_white_24dp);
        } else {
            super.onBackPressed();
        }
    }
    ...
    private void getCropImage(){
        if (CropMode) {
            ...
            Image.setGuidelines(CropImageView.Guidelines.ON);
            Image.setAspectRatio(AspectX, AspectY);
            Drawable drawable = ContextCompat.getDrawable(getBaseContext(), R.drawable.ic_crop_white_24dp);
            drawable.setColorFilter(new PorterDuffColorFilter(ContextCompat.getColor(getBaseContext(), R.color.colorSecondary), PorterDuff.Mode.MULTIPLY));
